        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
            ...
            <div className="max-w-2xl">
              ...
              <Link
                href="/visualizer"
                className="mt-8 inline-flex rounded-md bg-black px-6 py-3 text-[15px] font-medium text-white transition-opacity hover:opacity-80"
              >
                Запустить подбор
              </Link>
      ...
      <section id="contacts" className="border-t border-neutral-200">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link
              href="#request"
              className="inline-flex w-fit rounded-md bg-black px-6 py-3 text-[15px] font-medium text-white transition-opacity hover:opacity-80"
            >
              Оставить заявку
            </Link>
          </div>
