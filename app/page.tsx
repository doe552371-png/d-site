      ...
      <section className="flex min-h-[78vh] items-center border-b border-neutral-200">
        <div className="mx-auto w-full max-w-7xl px-6 py-20 lg:py-24">
          <div className="max-w-5xl">
            ...
            <h1 className="mt-6 max-w-4xl text-5xl font-medium uppercase leading-[0.96] tracking-tight text-neutral-900 sm:text-6xl lg:text-7xl">
              Детали, которые
              <br />
              создают пространство
            </h1>

            <p className="mt-8 max-w-xl text-lg font-normal leading-8 text-neutral-500">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/catalog"
                className="rounded-md bg-black px-6 py-3 text-base font-medium text-white transition-opacity hover:opacity-80"
              >
                Смотреть каталог
              </Link>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
            ...
            <div className="max-w-2xl">
              ...
              <Link
                href="/visualizer"
                className="mt-8 inline-flex rounded-md bg-black px-6 py-3 text-base font-medium text-white transition-opacity hover:opacity-80"
              >
                Запустить подбор
              </Link>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
            <div>
              ...
              <p className="mt-5 max-w-xl text-base font-normal leading-7 text-neutral-500">
      ...
      <section id="about" className="border-t border-neutral-200">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:py-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:gap-20">
            ...
            <p className="max-w-2xl text-lg font-normal leading-8 text-neutral-600">
      ...
      <section id="contacts" className="border-t border-neutral-200">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link
              href="#request"
              className="inline-flex w-fit rounded-md bg-black px-6 py-3 text-base font-medium text-white transition-opacity hover:opacity-80"
            >
              Оставить заявку
            </Link>
          </div>
