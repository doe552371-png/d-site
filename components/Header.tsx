    ...
    <header className="border-b border-neutral-200">
      <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link href="/pro" className="font-body border border-neutral-300 px-4 py-2.5 text-sm font-medium tracking-[0.06em] transition-colors hover:border-black hover:bg-black hover:text-white">ПРО</Link>
          <Link href="/#request" className="font-body bg-black px-5 py-2.5 text-sm font-medium text-white transition-opacity hover:opacity-80">Оставить заявку</Link>
        </div>
